...
shader_set_uniform_f(colouro,
cor[palette_index,0],cog[palette_index,0],cob[palette_index,0],coa[palette_index,0]);
...
shader_set_uniform_f(colouri,0,1,0,1);
shader_set_uniform_f(colouro,
cor[palette_index,1],cog[palette_index,1],cob[palette_index,1],coa[palette_index,1]);
draw_sprite(scn[2],0,0,0);
screen_save("screen2.png");
...
shader_set_uniform_f(colouri,0,0,1,1);
shader_set_uniform_f(colouro,
cor[palette_index,2],cog[palette_index,2],cob[palette_index,2],coa[palette_index,2]);
draw_sprite(scn[2],0,0,0);
screen_save("screen2.png");
...
shader_set_uniform_f(colouri,0,0,0,1);
shader_set_uniform_f(colouro,
cor[palette_index,3],cog[palette_index,3],cob[palette_index,3],coa[palette_index,3]);
draw_sprite(scn[2],0,0,0);
screen_save("screen2.png");
screen_alpha=sprite_add("screen2.png",0,0,0,0,0);
scn[0]=noone;
scn[1]=noone;
scn[2]=noone;
scn[3]=noone;
